/*
 ...
 Pego de https://github.com/batiste/sdl2-game-loop/
...
ListElement *getFromList(GenericList *list, int n)
{
	assert(list != NULL);
	ListElement *el = NULL;
	int i = 0;
...
int emptyList(GenericList *list)
{
...
int destroyList(GenericList *list)
{
	emptyList(list);
	free(list);
	return 0;
